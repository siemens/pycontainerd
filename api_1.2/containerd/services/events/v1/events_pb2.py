...
_ENVELOPE = _descriptor.Descriptor(
  ...
  serialized_options=_b('\200\271\037\001'),
  is_extendable=False,
  syntax='proto3',
  extension_ranges=[],
  oneofs=[
...
_PUBLISHREQUEST.fields_by_name['event'].message_type = containerd_dot_vendor_dot_google_dot_protobuf_dot_any__pb2._ANY
