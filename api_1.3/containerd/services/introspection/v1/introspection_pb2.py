...
from containerd.vendor.google.rpc import status_pb2 as containerd_dot_vendor_dot_google_dot_rpc_dot_status__pb2
...
_SERVERRESPONSE = _descriptor.Descriptor(
  ...
  fields=[
    _descriptor.FieldDescriptor(
      ...
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=_b('\342\336\037\004UUID'), file=DESCRIPTOR),
  ],
  extensions=[
  ],
  nested_types=[],
...
_PLUGIN.fields_by_name['init_err'].message_type = containerd_dot_vendor_dot_google_dot_rpc_dot_status__pb2._STATUS
