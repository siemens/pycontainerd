...
# source: containerd/vendor/google/rpc/error_details.proto
...
_RETRYINFO.fields_by_name['retry_delay'].message_type = containerd_dot_vendor_dot_google_dot_protobuf_dot_duration__pb2._DURATION
...
RetryInfo = _reflection.GeneratedProtocolMessageType('RetryInfo', (_message.Message,), {
  ...
  '__module__' : 'containerd.vendor.google.rpc.error_details_pb2'
