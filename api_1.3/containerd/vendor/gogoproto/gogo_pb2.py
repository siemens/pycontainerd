...
# source: containerd/vendor/gogoproto/gogo.proto
...
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.EnumOptions.RegisterExtension(goproto_enum_prefix)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.EnumOptions.RegisterExtension(goproto_enum_stringer)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.EnumOptions.RegisterExtension(enum_stringer)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.EnumOptions.RegisterExtension(enum_customname)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.EnumOptions.RegisterExtension(enumdecl)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.EnumValueOptions.RegisterExtension(enumvalue_customname)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(goproto_getters_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(goproto_enum_prefix_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(goproto_stringer_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(verbose_equal_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(face_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(gostring_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(populate_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(stringer_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(onlyone_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(equal_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(description_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(testgen_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(benchgen_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(marshaler_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(unmarshaler_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(stable_marshaler_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(sizer_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(goproto_enum_stringer_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(enum_stringer_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(unsafe_marshaler_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(unsafe_unmarshaler_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(goproto_extensions_map_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(goproto_unrecognized_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(gogoproto_import)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(protosizer_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(compare_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(typedecl_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(enumdecl_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(goproto_registration)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(messagename_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(goproto_sizecache_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FileOptions.RegisterExtension(goproto_unkeyed_all)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(goproto_getters)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(goproto_stringer)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(verbose_equal)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(face)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(gostring)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(populate)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(stringer)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(onlyone)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(equal)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(description)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(testgen)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(benchgen)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(marshaler)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(unmarshaler)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(stable_marshaler)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(sizer)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(unsafe_marshaler)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(unsafe_unmarshaler)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(goproto_extensions_map)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(goproto_unrecognized)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(protosizer)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(compare)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(typedecl)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(messagename)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(goproto_sizecache)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.MessageOptions.RegisterExtension(goproto_unkeyed)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(nullable)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(embed)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(customtype)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(customname)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(jsontag)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(moretags)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(casttype)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(castkey)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(castvalue)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(stdtime)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(stdduration)
containerd_dot_vendor_dot_google_dot_protobuf_dot_descriptor__pb2.FieldOptions.RegisterExtension(wktpointer)
