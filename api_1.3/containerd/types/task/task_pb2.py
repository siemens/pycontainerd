...
_STATUS = _descriptor.EnumDescriptor(
  ...
  values=[
    _descriptor.EnumValueDescriptor(
      ...
      serialized_options=_b('\212\235 \rStatusUnknown'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='CREATED', index=1, number=1,
      serialized_options=_b('\212\235 \rStatusCreated'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='RUNNING', index=2, number=2,
      serialized_options=_b('\212\235 \rStatusRunning'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='STOPPED', index=3, number=3,
      serialized_options=_b('\212\235 \rStatusStopped'),
      type=None),
    _descriptor.EnumValueDescriptor(
      name='PAUSED', index=4, number=4,
      serialized_options=_b('\212\235 \014StatusPaused'),
      type=None),
    _descriptor.EnumValueDescriptor(
...
_PROCESS.fields_by_name['exited_at'].message_type = containerd_dot_vendor_dot_google_dot_protobuf_dot_timestamp__pb2._TIMESTAMP
_PROCESSINFO.fields_by_name['info'].message_type = containerd_dot_vendor_dot_google_dot_protobuf_dot_any__pb2._ANY
